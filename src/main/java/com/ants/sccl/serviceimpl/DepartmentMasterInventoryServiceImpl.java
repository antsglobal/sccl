...
//	}
	...
	public void departmentStockService(RefilDepartmentStock refilDepartmentStock) {
		...
		departmentMasterInventoryRepository.departmentStock(refilDepartmentStock.getId(),
				refilDepartmentStock.getDepartmentName(),refilDepartmentStock.getPartName(),
				refilDepartmentStock.getBrand(), refilDepartmentStock.getRefilQuantity(),
				refilDepartmentStock.getRefilDate());
		
	}

	@Override
	public List<DepartmentMasterInventory> departmentStockFilters(String stockInput) {
		return departmentMasterInventoryRepository.departmentStockFilter(stockInput);
	}
